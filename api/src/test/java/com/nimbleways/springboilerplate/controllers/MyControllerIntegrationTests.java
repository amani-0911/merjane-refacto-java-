...
public class MyControllerIntegrationTests {
        ...
        private static List<Product> createProducts() {
                ...
                products.add(new Product(null, 15, 30, ProductType.NORMAL, "USB Cable", null, null, null,null, null,0));
                products.add(new Product(null, 10, 0, ProductType.NORMAL, "USB Dongle", null, null, null,null, null,0));
                products.add(new Product(null, 15, 30, ProductType.EXPIRABLE, "Butter", LocalDate.now().plusDays(26), null,
                                null,null, null,0));
                products.add(new Product(null, 90, 6, ProductType.EXPIRABLE, "Milk", LocalDate.now().minusDays(2), null, null,null, null,0));
                products.add(new Product(null, 15, 30, ProductType.SEASONAL, "Watermelon", null, LocalDate.now().minusDays(2),
                                LocalDate.now().plusDays(58),null, null,0));
                products.add(new Product(null, 15, 30, ProductType.SEASONAL, "Grapes", null, LocalDate.now().plusDays(180),
                                LocalDate.now().plusDays(240),null, null,0));
                return products;
        }
}
